...
const DropMegaMenu = () => {
  return (
    <div className="hidden absolute left-0 container mt-8 p-9 z-10 w-full group-hover:flex justify-between bg-white rounded-xl  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
